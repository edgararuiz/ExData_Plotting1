...
#Plot 1 
png(filename="plot1.png", width=480, height =480, units="px") # Starting the PNG file save
hist(pc$Global_active_power, col="red", main="Global Active Power", xlab = "Global Active Power (kilowats)") # Creating the histogram
